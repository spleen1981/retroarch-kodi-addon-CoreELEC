...
_ENTRIES: tuple[Entry, ...] = (
    ...
    Entry(32032, "#32032", {
        'en_gb': 'Synchronize RetroArch resources now',
        'es_es': 'Sincronizar recursos de RetroArch ahora',
        'cs_cz': 'Synchronizovat prostředky RetroArch nyní',
        'it_it': 'Sincronizza le risorse RetroArch ora',
        'zh_cn': '立即同步 RetroArch 资源',
        'sk_sk': 'Synchronizovať prostriedky RetroArch teraz',
        'pt_br': 'Sincronizar recursos do RetroArch agora',
        'de_de': 'RetroArch-Ressourcen jetzt synchronisieren',
    }),
    Entry(32033, "#32033", {
