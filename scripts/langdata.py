...
_ENTRIES: tuple[Entry, ...] = (
    ...
    Entry(32044, "#32044", {
        ...
        'es_es': 'Probando conexión...',
        'cs_cz': 'Testování připojení...',
        'it_it': 'Prova della connessione...',
        'zh_cn': '正在测试连接...',
        'sk_sk': 'Testuje sa pripojenie...',
        'pt_br': 'Testando conexão...',
        'de_de': 'Verbindung wird getestet...',
    }),
    Entry(32045, "#32045", {
        'en_gb': 'Connection successful',
        'es_es': 'Conexión correcta',
        'cs_cz': 'Připojení úspěšné',
        'it_it': 'Connessione riuscita',
        'zh_cn': '连接成功',
        'sk_sk': 'Pripojenie úspešné',
        'pt_br': 'Conexão bem-sucedida',
        'de_de': 'Verbindung erfolgreich',
    }),
    Entry(32046, "#32046", {
        'en_gb': 'Connection failed',
        'es_es': 'Error de conexión',
        'cs_cz': 'Připojení selhalo',
        'it_it': 'Connessione fallita',
        'zh_cn': '连接失败',
        'sk_sk': 'Pripojenie zlyhalo',
        'pt_br': 'Falha na conexão',
        'de_de': 'Verbindung fehlgeschlagen',
    }),
    Entry(32047, "#32047", {
        'en_gb': 'Check the username and password.',
        'es_es': 'Comprueba el usuario y la contraseña.',
        'cs_cz': 'Zkontrolujte uživatelské jméno a heslo.',
        'it_it': 'Controlla nome utente e password.',
        'zh_cn': '请检查用户名和密码。',
        'sk_sk': 'Skontrolujte používateľské meno a heslo.',
        'pt_br': 'Verifique o nome de usuário e a senha.',
        'de_de': 'Benutzername und Passwort prüfen.',
    }),
    Entry(32048, "#32048", {
        ...
        'de_de': 'Der Server hat das Protokoll abgelehnt. Versuchen Sie eine andere SMB-Protokollversion oder verwenden Sie das Stammverzeichnis der Freigabe.',
    }),
    Entry(32049, "#32049", {
        'en_gb': 'The server is unreachable. Check the address and the network.',
        'es_es': 'El servidor no es accesible. Comprueba la dirección y la red.',
        'cs_cz': 'Server je nedostupný. Zkontrolujte adresu a síť.',
        'it_it': 'Il server non è raggiungibile. Controlla indirizzo e rete.',
        'zh_cn': '无法连接到服务器。请检查地址和网络。',
        'sk_sk': 'Server je nedostupný. Skontrolujte adresu a sieť.',
        'pt_br': 'O servidor está inacessível. Verifique o endereço e a rede.',
        'de_de': 'Der Server ist nicht erreichbar. Adresse und Netzwerk prüfen.',
    }),
    Entry(32050, "#32050", {
        'en_gb': 'The share does not exist on the server.',
        'es_es': 'El recurso compartido no existe en el servidor.',
        'cs_cz': 'Sdílená složka na serveru neexistuje.',
        'it_it': 'La condivisione non esiste sul server.',
        'zh_cn': '服务器上不存在该共享。',
        'sk_sk': 'Zdieľaný priečinok na serveri neexistuje.',
        'pt_br': 'O compartilhamento não existe no servidor.',
        'de_de': 'Die Freigabe existiert auf dem Server nicht.',
    }),
    Entry(32051, "#32051", {
        'en_gb': 'Enable the remote ROMs folder and set a path first.',
        'es_es': 'Activa primero la carpeta remota de ROMs y establece una ruta.',
        'cs_cz': 'Nejprve povolte vzdálenou složku ROMs a zadejte cestu.',
        'it_it': 'Abilita prima la cartella ROM remota e imposta un percorso.',
        'zh_cn': '请先启用远程 ROM 文件夹并设置路径。',
        'sk_sk': 'Najprv povoľte vzdialený priečinok ROMiek a zadajte cestu.',
        'pt_br': 'Ative primeiro a pasta remota de ROMs e defina um caminho.',
        'de_de': 'Aktivieren Sie zuerst den Remote-ROM-Ordner und legen Sie einen Pfad fest.',
    }),
    Entry(32052, "#32052", {
        'en_gb': 'entries found',
        'es_es': 'elementos encontrados',
        'cs_cz': 'nalezených položek',
        'it_it': 'elementi trovati',
        'zh_cn': '个项目',
        'sk_sk': 'nájdených položiek',
        'pt_br': 'itens encontrados',
        'de_de': 'Einträge gefunden',
    }),
