...
LANG_0_pt_br="RetroArch add-on para Kodi (${RA_NAME_SUFFIX}). RetroArch é um frontend para emuladores, motores de jogos e reprodutores de mídia."
...
LANG_1_pt_br="O add-on fornece binário, núcleos e configurações básicas para iniciar o RetroArch a partir da UI do Kodi, além de recursos adicionais para melhorar a experiência do usuário. Ele é construído a partir das fontes do Lakka."
...
LANG_32002_pt_br="Desligar controles do Xbox360 depois de fechar o RetroArch"
...
LANG_32008_pt_br="Salvar registros do RetroArch para arquivo"
...
LANG_32009_pt_br="Desligar os controles BT controllers ao sair do RetroArch (se suportado)"
...
LANG_32010_pt_br="Iniciar o sistema em"
...
LANG_32011_pt_br="Atualmente o sistema inicializa em"
