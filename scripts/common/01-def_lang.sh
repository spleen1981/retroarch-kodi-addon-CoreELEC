...
LANG_0_es_es="Complemento RetroArch para Kodi (${RA_NAME_SUFFIX}). RetroArch es una interfaz para emuladores, motores de juegos y reproductores multimedia."
...
LANG_1_es_es="El complemento proporciona binarios, núcleos y ajustes básicos para iniciar RetroArch desde la interfaz de usuario de Kodi, además de funciones adicionales para mejorar la experiencia del usuario. Está construido a partir de fuentes Lakka."
...
LANG_2_es_es="Se trata de un complemento no oficial. Utilice github.com/spleen1981/retroarch-kodi-addon-CoreELEC para enviar problemas."
...
LANG_32002_es_es="Apagar los mandos de Xbox360 después de cerrar RetroArch"
...
LANG_32003_es_es="Utilizar el mando a distancia (CEC) con RetroArch"
...
LANG_32004_es_es="Anular la configuración de la frecuencia de actualización de Kodi"
...
LANG_32006_es_es="Sincronizar controlador/dispositivo de audio RetroArch con Kodi"
...
LANG_32007_es_es="Montar ruta remota para ROMs RetroArch"
...
LANG_32009_es_es="Desactivar los controladores BT al salir de RetroArch (si es compatible)"
...
LANG_32010_es_es="Arrancar el sistema en"
...
LANG_32011_es_es="Actualmente el sistema arranca en"
...
LANG_32012_es_es="¿Desea cambiar la configuración y arrancar en"
...
LANG_32014_es_es="Activar sugerencias"
...
LANG_32015_es_es="No se han encontrado los activos de RetroArch. Los activos mejoran la apariencia de la interfaz gráfica de usuario y pueden descargarse desde Retroarch seleccionando "Actualizador en línea > Actualizar activos" (o copiándolos manualmente en la carpeta de activos)."
